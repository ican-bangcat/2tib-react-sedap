  ...
  return (
    ...
    >
      ...
      <div id="search-bar" className="relative w-full max-w-lg">
        <input id="search-input" type="text" placeholder="Search Here..." className="border border-gray-100 p-2 pr-10 bg-white w-full max-w-lg rounded-md outline-none"/>
      ...
      <div id="icons-container" className="flex items-center space-x-4">
        ...
        <div id="profile-container" className="flex items-center space-x-4 border-l pl-4 border-gray-300">
          <span id="profile-text">
            Hello, <b>Daniel Anderson Sipahutar</b>
          </span>
          <img
            id="profile-avatar"
